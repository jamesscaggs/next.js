      ...
      <div className="px-6 h-16 flex justify-between items-center lg:items-stretch mx-auto">
        ...
        <div className="h-full hidden xl:flex items-center justify-end">
          <div className="h-full flex">
            <div className="text-gray-600 w-20 h-full flex items-center justify-center border-l border-gray-300">
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="text-gray-600 w-20 h-full flex items-center justify-center border-l border-r border-gray-300 cursor-pointer">
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="text-gray-600 w-20 h-full flex items-center justify-center border-r border-gray-300 cursor-pointer">
              <svg
                xmlns="http://www.w3.org/2000/svg"
